        ...
        <div className="board-container">
            <div className={`board ${winnerEffect}`}>
                <div className={animation ? "profitContainer addOpacity": "profitContainer"}>
                    ...
                    <span id="gained"><font color="#2fe2e1">Gained: </font>{gain} EvoX</span>
                </div>
                ...
                <div className={playable ? "spin-container" : "spin-container disabled-btn"}><button type="button" className="spin" onClick={()=>{play(); playFeature()}}>PLAY</button></div>
